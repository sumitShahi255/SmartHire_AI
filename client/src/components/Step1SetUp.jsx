...
function Step1SetUp({onStart}) {
  ...
  const handleStart = async () => {
    ...
    try {
      ...
      console.log(error)
      setLoading(false)
      alert(error.response?.data?.message || "Something went wrong while generating questions");
    }
  }
  return (
    <motion.div
    ...
    className='min-h-screen flex items-center justify-center bg-linear-to-br from-green-50 via-white to-gray-100 px-4'>
      ...
      <div className='w-full max-w-6xl bg-white rounded-3xl shadow-2xl grid md:grid-cols-2 overflow-hidden'>
        ...
        className='relative bg-linear-to-br from-green-50 to-green-100 p-12 flex flex-col justify-center'>
          ...
          <h2 className='text-4xl font-bold text-gray-800 mb-6'>
            Ace Your Next <span className='text-green-600'>AI Interview</span>
          </h2>


          <p className='text-gray-600 mb-4'>
           Practice real-world interviews with AI. Improve communication, technical skills, and confidence.
          </p>
          ...
          <div className='space-y-5'>
            {
              [
                {
                  icon: <UserRound className='text-green-600 text-xl'/>,
                  text:"Personalize Your Interview Path"
                },
                {
                  icon: <Mic className='text-green-600 text-xl'/>,
                  text:"AI-Powered Mock Interviews" 
                },
                {
                  icon: <TrendingUp className='text-green-600 text-xl'/>,
                  text:"Detailed Feedback & Insights"
                }
              ].map((item,index) => (
                ...
                className='flex items-center space-x-4 bg-white p-4 rounded-xl shadow-sm cursor-pointer 
                    hover:shadow-lg hover:-translate-y-1 transition-all duration-300 border border-gray-100'>
        ...
        className='p-12 bg-white'>
          ...
          <h2 className='text-3xl font-bold text-gray-800 mb-2'>Set Up Your Interview</h2>

          <p className='text-gray-500 mb-6'>
            Fill in details to generate a personalized interview experience
          </p>
          ...
          <div className='space-y-6'>
            ...
            <select value={mode}
              ...
              {!analysisDone && (
                ...
                hover:border-green-500 hover:bg-green-50 transition flex flex-col items-center justify-center'>

                  <Upload className='text-4xl mx-auto text-green-600 mb-3'/>

                  <input type='file' id = "resumeUpload" accept='application/pdf' className='hidden'
                  onChange={(e) => setResumeFile(e.target.files[0])}/>

                  <p className='text-gray-600 font-medium'>
                    {resumeFile ? resumeFile.name : "Upload Your Resume (Optional but Recommended)"}
                  </p>
                  ...
                  {resumeFile && (
                    ...
                    className='mt-4 bg-gray-900 text-white px-5 py-2 rounded-lg hover:bg-gray-800 transition'>
                      ...
                      {analyzing ? "Analyzing Your Resume..." : "Analyze & Auto-Fill Details"}
              ...
              {analysisDone && (
                ...
                className='bg-white border border-gray-200 rounded-xl p-5 space-y-4 shadow-sm'>
                  <h3 className='text-lg font-semibold text-gray-800'>AI Resume Insights</h3>
              ...
              onClick={handleStart}
               ...
               whileHover={{scale:1.03}}
               whileTap={{scale:0.95}}
               className='w-full disabled:bg-gray-600 bg-green-600 hover:bg-green-600 text-white py-3 
