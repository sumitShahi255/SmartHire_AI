  ...
  const plans = [
    {
      ...
      price: "₹0",
      credits: 100,
      description : "Ideal for beginners starting their interview preparation journey.",
      features: [
    ...
    },
    {
      ...
      price: "₹100",
      credits: 150,
      description : "Perfect for consistent practice and improving interview performance.",
      features: [
    ...
    },
    {
      ...
      price: "₹500",
      credits: 650,
      description : "Best choice for serious job seekers and placement preparation.",
      features: [
    ...
    <div className='min-h-screen bg-linear-to-br from-gray-50 to-emerald-50 py-16 px-6'>
      ...
      <div className='max-w-6xl mx-auto mb-14 flex items-center gap-4'>
        ...
        <div className='text-center w-full'>
          <h1 className='text-4xl font-bold text-gray-800'>Choose the Perfect Plan</h1>
          <p className='text-gray-500 mt-3 text-lg'>Flexible pricing designed to help you practice, improve, and succeed in interviews.</p>
        </div>
              ...
              <div className='mt-6 space-y-3 text-left'>
                {plan.features.map((feature,i) => (
                  ...
                  className='flex items-center gap-3'>
                    <BadgeCheck className='text-emerald-500 text-sm'/>
